...
int Sci_WriteSettings (struct s_reader * reader, BYTE T, unsigned long fs, 
                       unsigned long ETU, unsigned long WWT, unsigned long BWT,
                       unsigned long CWT, unsigned long EGT, unsigned char P, unsigned char I);
